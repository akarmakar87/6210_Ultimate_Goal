...
public class Red1t extends UltimateGoalLinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //degrees on that position the wobble arm will directly face Wobble 2.
            ...
            if (pos == 1 || pos == 0)
                driveAdjustShooter(-1, dist - 8, angle, 5000, 0.75);  //mid goal = 'max = .95'
            else
                driveAdjustShooter(-1, dist - 8, angle+2, 5000, 0.75);  //mid goal = 'max = .95'
            //setWobbleClaw(true);
            ...
            if (pos == 0)
                ...
                turnPID(174, 0.6 / 180, 0.00005, 0.1, 3000);  // 170
